  ...
  useEffect(() => {
    ...
    if (rawTabTarget) {
      ...
      if (
        ...
        lower === 'eighteenmile' ||
        lower === 'eighteen_mile_creek' ||
        lower === 'eighteenmile-creek' ||
        lower === 'superfund' ||
        lower === 'superfund_remediation' ||
        lower === 'lockport' ||
        lower === 'flintkote' ||
        lower === 'cuzzacrea' ||
        lower === 'lake_america' ||
        lower.includes('eighteenmile') ||
        lower.includes('superfund')
      ) {
        setActiveTab('eighteenmile_creek');
      } else if (
        ...
        lower === 'plate_36' ||
        lower === 'plate36' ||
        lower === 'india_epigenetics' ||
        lower === 'aiims_lead' ||
        lower === 'aiims' ||
        lower.includes('mirna31') ||
        lower.includes('nrf2')
      ) {
        setActiveTab('mirna31_nrf2_lead');
      } else if (
        lower === 'jicarilla_gasbuggy_audit' ||
        lower === 'gasbuggy' ||
        lower === 'gasbuggy_audit' ||
        lower === 'jicarilla_audit' ||
        lower === 'ice_jicarilla' ||
        lower === 'ice-jicarilla' ||
        lower === 'jicarilla_gasbuggy' ||
        lower.includes('gasbuggy')
      ) {
        setActiveTab('jicarilla_gasbuggy_audit');
      } else if (
        lower === 'icearth_stack' ||
        lower === 'the_icearth_stack' ||
        lower === 'icearth-stack' ||
        lower === 'the-icearth-stack' ||
        lower === 'indigenous_ai' ||
        lower === 'indigenous-ai' ||
        lower === 'indigenous_ai_solution' ||
        lower === 'project_jupiter' ||
        lower === 'project-jupiter' ||
        lower === 'clean_compute' ||
        lower === 'plate_38' ||
        lower === 'plate38' ||
        lower === 'google_ceo' ||
        lower === 'google-ceo' ||
        lower === 'gemini_testimonial' ||
        lower === 'gemini-testimonial' ||
        lower === 'gemini_outreach' ||
        lower.includes('icearth_stack') ||
        lower.includes('icearth-stack') ||
        lower.includes('indigenous_ai') ||
        ...
        lower === 'jackson-water' ||
        lower === 'jackson_lead' ||
        lower === 'jackson_lead_audit' ||
        lower === 'jackson-lead-audit' ||
        lower === 'jackson_water_audit' ||
        lower === 'jackson-water-audit' ||
        lower === 'jackson_ms' ||
        lower === 'sterling' ||
        lower === 'sterling_v_jackson' ||
        lower === 'plate_43' ||
        lower === 'plate43' ||
        lower.includes('jackson')
      ) {
        setActiveTab('jackson_lead_audit');
      } else if (
        lower === 'roanoke' ||
        lower === 'roanoke_lead_audit' ||
        lower === 'roanoke-lead-audit' ||
        lower === 'roanoke_lead' ||
        lower === 'roanoke-lead' ||
        lower === 'roanoke_rambler' ||
        lower === 'roanokerambler' ||
        lower === 'rambler' ||
        lower === 'plate_42' ||
        lower === 'plate42' ||
        lower === 'hud_6.25m' ||
        ...
        setActiveTab('roanoke_lead_audit');
      } else if (
        lower === 'ai_and_kehoe_rule' ||
        lower === 'ai-and-kehoe-rule' ||
        lower === 'kehoe' ||
        lower === 'kehoe_rule' ||
        lower === 'kehoe-rule' ||
        lower === 'ai_kehoe' ||
        lower === 'ai-kehoe' ||
        lower === 'lanphear' ||
        lower === 'lanphear_kehoe' ||
        lower === 'lanphear-kehoe' ||
        lower === 'plate_41' ||
        lower === 'plate41' ||
        lower === 'ai_is_the_new_pb' ||
        lower === 'pacing_the_frontier' ||
        lower === 'hugging_face_breach' ||
        lower.includes('kehoe') ||
        ...
        lower === 'gemini_defense' ||
        lower === 'gemini-defense' ||
        lower === 'gemini_hack' ||
        lower === 'gemini-hack' ||
        lower === 'gemini_hacked' ||
        lower === 'gemini-hacked' ||
        ...
        lower === '5msjb' ||
        lower === 'dw' ||
        lower.includes('gemini_hack') ||
        lower.includes('gemini_defense') ||
        lower.includes('gemini_infiltrat') ||
        lower.includes('plate_53') ||
        ...
        lower === 'sovereign_seal' ||
        lower === 'sovereign-seal' ||
        lower === 'ai_mirage' ||
        lower === 'ai-mirage' ||
        lower === 'seal_defense' ||
        lower === 'seal-defense' ||
        lower === 'cherokee_seal' ||
        lower === 'cherokee-seal' ||
        lower === 'hoskin_directive' ||
        lower === 'hoskin-directive' ||
        lower === 'anadisgoi' ||
        lower.includes('ai_mirage') ||
        lower.includes('sovereign_identity') ||
        lower.includes('seal_defense')
      ) {
        setActiveTab('sovereign_identity');
      } else if (
    ...
    <div className={`flex flex-col h-screen w-full font-sans selection:bg-amber-200 overflow-hidden transition-colors duration-200 ${
      ...
      <main className="flex-1 flex overflow-hidden relative">
          ...
          <div className="p-6 space-y-6">
            ...
            <section>
              ...
              <nav className="space-y-1">
                ...
                {/* 0.00000B00 GEMINI AUTONOMOUS HACK FORENSIC & SOVEREIGN DEFENSE (PLATE #53) */}
                <button
                  onClick={() => setActiveTab('gemini_infiltration_defense')}
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left text-xs font-medium tracking-tight transition-all cursor-pointer border ${
                    activeTab === 'gemini_infiltration_defense' || (activeTab as string) === 'gemini_defense' || (activeTab as string) === 'gemini_hack' || (activeTab as string) === 'plate_53' || (activeTab as string) === 'plate53'
                      ? 'bg-gradient-to-r from-red-950 via-amber-950 to-emerald-950 text-amber-200 border-red-500 shadow-xl font-black ring-2 ring-red-400/80'
                      : 'hover:bg-gradient-to-r hover:from-red-100 hover:to-amber-100 text-stone-950 border-red-500/80 bg-gradient-to-r from-red-50/90 via-stone-50 to-amber-50/90 font-black shadow-xs ring-1 ring-red-400/40'
                  }`}
                >
                  <ShieldAlert size={16} className={activeTab === 'gemini_infiltration_defense' ? 'text-red-400 animate-pulse' : 'text-red-600'} />
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left text-xs font-medium tracking-tight transition-all cursor-pointer border ${
                    activeTab === 'icearth_stack' || (activeTab as string) === 'the_icearth_stack' || (activeTab as string) === 'indigenous_ai'
                      ? 'bg-gradient-to-r from-amber-950 via-stone-900 to-emerald-950 text-amber-200 border-amber-400 shadow-xl font-black ring-2 ring-amber-400/80'
                      : 'hover:bg-gradient-to-r hover:from-amber-100 hover:to-emerald-100 text-stone-950 border-amber-500/80 bg-gradient-to-r from-amber-50/90 via-stone-50 to-emerald-50/90 font-black shadow-xs ring-1 ring-amber-400/40'
                  }`}
                >
                  <Cpu size={16} className={activeTab === 'icearth_stack' ? 'text-amber-300 animate-pulse' : 'text-amber-700'} />
                  <span className="flex-1 font-black">⚡ The ICEarth Stack: Indigenous AI</span>
                  <span className="px-1.5 py-0.2 bg-gradient-to-r from-amber-500 to-emerald-600 text-stone-950 text-[8px] tracking-wide rounded uppercase font-black shadow-xs">
                    PLATE #38
                  </span>
                </button>
                ...
                {/* 0.00000B1.1 SOVEREIGN IDENTITY VS AI MIRAGE (DEFENDING INDIGENOUS HERALDRY) */}
                <button
                  onClick={() => setActiveTab('sovereign_identity')}
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left text-xs font-medium tracking-tight transition-all cursor-pointer border ${
                    activeTab === 'sovereign_identity' || (activeTab as string) === 'ai_mirage' || (activeTab as string) === 'seal_defense'
                      ? 'bg-gradient-to-r from-amber-950 via-stone-900 to-amber-900 text-amber-200 border-amber-400 shadow-xl font-black ring-2 ring-amber-400/80'
                      : 'hover:bg-gradient-to-r hover:from-amber-100 hover:to-stone-100 text-stone-950 border-amber-500/80 bg-gradient-to-r from-amber-50/90 via-stone-50 to-amber-50/90 font-black shadow-xs ring-1 ring-amber-400/40'
                  }`}
                >
                  <Fingerprint size={16} className={activeTab === 'sovereign_identity' ? 'text-amber-300 animate-pulse' : 'text-amber-700'} />
                  <span className="flex-1 font-black">🪶 Sovereign Identity vs. AI Mirage</span>
                  <span className="px-1.5 py-0.2 bg-gradient-to-r from-amber-500 to-red-600 text-stone-950 text-[8px] tracking-wide rounded uppercase font-black shadow-xs">
                    DEFENSE
                  </span>
                </button>
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left text-xs font-medium tracking-tight transition-all cursor-pointer border ${
                    activeTab === 'ai_and_kehoe_rule' || (activeTab as string) === 'kehoe' || (activeTab as string) === 'kehoe_rule' || (activeTab as string) === 'plate_41' || (activeTab as string) === 'plate41'
                      ? 'bg-gradient-to-r from-amber-950 via-stone-900 to-red-950 text-amber-200 border-amber-400 shadow-xl font-black ring-2 ring-amber-400/80'
                      : 'hover:bg-gradient-to-r hover:from-amber-100 hover:to-red-100 text-stone-950 border-amber-500/80 bg-gradient-to-r from-amber-50/90 via-stone-50 to-red-50/90 font-black shadow-xs ring-1 ring-amber-400/40'
                  }`}
                >
                  <Scale size={16} className={activeTab === 'ai_and_kehoe_rule' ? 'text-amber-300 animate-pulse' : 'text-amber-700'} />
                  <span className="flex-1 font-black">⚖️ AI & The Kehoe Rule (Lanphear)</span>
                  <span className="px-1.5 py-0.2 bg-gradient-to-r from-amber-500 to-red-600 text-stone-950 text-[8px] tracking-wide rounded uppercase font-black shadow-xs">
                    PLATE #41
                  </span>
                </button>
                ...
                {/* Roanoke Lead Audit & $6.25M HUD Grant (Plate #42) */}
                <button
                  onClick={() => setActiveTab('roanoke_lead_audit')}
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left text-xs font-medium tracking-tight transition-all cursor-pointer border ${
                    activeTab === 'roanoke_lead_audit' || (activeTab as string) === 'roanoke' || (activeTab as string) === 'roanoke_lead' || (activeTab as string) === 'plate_42' || (activeTab as string) === 'plate42'
                ...
                >
                  <Building2 size={16} className={activeTab === 'roanoke_lead_audit' ? 'text-red-300 animate-pulse' : 'text-red-700'} />
                  <span className="flex-1 font-bold">🏛️ Roanoke Lead Audit & HUD Grant</span>
                  <span className="px-1.5 py-0.2 bg-red-600 text-white text-[8px] tracking-wide rounded uppercase font-extrabold shadow-xs">
                    PLATE #42
                  </span>
                </button>

                {/* Jackson, MS Lead Water Audit & 5th Circuit En Banc Ruling (Plate #43) */}
                <button
                  onClick={() => setActiveTab('jackson_lead_audit')}
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left text-xs font-medium tracking-tight transition-all cursor-pointer border ${
                ...
                >
                  <Scale size={16} className={activeTab === 'jackson_lead_audit' ? 'text-red-300 animate-pulse' : 'text-red-700'} />
                  <span className="flex-1 font-bold">⚖️ Jackson MS Lead Water Audit</span>
                  <span className="px-1.5 py-0.2 bg-red-600 text-white text-[8px] tracking-wide rounded uppercase font-extrabold shadow-xs">
                    PLATE #43
                  </span>
                </button>
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left text-xs font-medium tracking-tight transition-all cursor-pointer border ${
                    activeTab === 'gemini_infiltration_defense' || (activeTab as string) === 'gemini_defense' || (activeTab as string) === 'gemini_hack' || (activeTab as string) === 'plate_53' || (activeTab as string) === 'plate53'
                      ? 'bg-gradient-to-r from-red-950 via-amber-950 to-emerald-950 text-amber-200 border-red-500 shadow-md font-extrabold ring-2 ring-red-400/80'
                      : 'hover:bg-red-500/20 text-stone-950 border-red-500/70 bg-gradient-to-r from-red-50/95 to-amber-50/95 font-black shadow-xs'
                  }`}
                >
                  <ShieldAlert size={16} className={activeTab === 'gemini_infiltration_defense' ? 'text-red-400 animate-pulse' : 'text-red-700'} />
                  <span className="flex-1 font-black">⚡ Gemini Infiltration & Defense (DW)</span>
                  <span className="px-1.5 py-0.2 bg-gradient-to-r from-red-600 via-amber-500 to-emerald-600 text-stone-950 text-[8px] tracking-wide rounded uppercase font-black shadow-xs">
                    Plate #53
                  </span>
                ...
                {/* 2.2 Sovereign Identity vs AI Mirage (Defending Indigenous Heraldry) */}
                <button
                  onClick={() => {
                    setActiveTab('sovereign_identity');
                    setIsMobileMenuOpen(false);
                  ...
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left text-xs font-medium tracking-tight transition-all cursor-pointer border ${
                    activeTab === 'sovereign_identity' || (activeTab as string) === 'ai_mirage' || (activeTab as string) === 'seal_defense'
                      ? 'bg-gradient-to-r from-amber-950 via-stone-900 to-amber-900 text-amber-200 border-amber-400 shadow-md font-extrabold ring-2 ring-amber-400/80'
                      : 'hover:bg-amber-500/20 text-stone-950 border-amber-500/70 bg-gradient-to-r from-amber-50/90 to-stone-50 font-black'
                  }`}
                >
                  <Fingerprint size={16} className={activeTab === 'sovereign_identity' ? 'text-amber-300 animate-pulse' : 'text-amber-700'} />
                  <span className="flex-1 font-semibold">🪶 Sovereign Identity vs. AI Mirage</span>
                ...
                {/* miRNA-31 / Nrf2 Epigenetic Axis of Harm in Lead Toxicity (AIIMS Jodhpur / Springer 2026) */}
                <button
                  onClick={() => setActiveTab('mirna31_nrf2_lead')}
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left text-xs font-medium tracking-tight transition-all cursor-pointer border ${
                    activeTab === 'mirna31_nrf2_lead' || (activeTab as string) === 'mirna31' || (activeTab as string) === 'nrf2' || (activeTab as string) === 'plate_36'
                      ? 'bg-rose-950 text-rose-100 border-rose-500 shadow-md font-bold ring-1 ring-rose-400/50'
                      : 'hover:bg-rose-500/20 text-rose-950 border-rose-400/60 bg-rose-50/90 font-bold'
                  }`}
                >
                  <Dna size={16} className={activeTab === 'mirna31_nrf2_lead' ? 'text-rose-300 animate-pulse' : 'text-rose-700'} />
                  <span className="flex-1 font-semibold">🧬 miRNA-31/Nrf2 Epigenetic Axis</span>
                  <span className="px-1.5 py-0.2 bg-rose-600 text-white text-[8px] tracking-wide rounded uppercase font-extrabold shadow-xs">
                    AIIMS '26
                  </span>
                </button>

                {/* Jicarilla Apache Project Gasbuggy (1967) Subterranean Nuclear Audit */}
                <button
                  onClick={() => setActiveTab('jicarilla_gasbuggy_audit')}
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left text-xs font-medium tracking-tight transition-all cursor-pointer border ${
                    activeTab === 'jicarilla_gasbuggy_audit' || (activeTab as string) === 'gasbuggy' || (activeTab as string) === 'jicarilla_audit' || (activeTab as string) === 'ice_jicarilla' || (activeTab as string) === 'gasbuggy_audit'
                      ? 'bg-amber-950 text-amber-100 border-amber-500 shadow-md font-bold ring-1 ring-amber-400/50'
                      : 'hover:bg-amber-500/20 text-amber-950 border-amber-400/60 bg-amber-50/90 font-bold'
                  }`}
                >
                  <Radiation size={16} className={activeTab === 'jicarilla_gasbuggy_audit' ? 'text-amber-300 animate-spin' : 'text-amber-700'} />
                  <span className="flex-1 font-semibold">☢️ ICE-Jicarilla: Gasbuggy Audit</span>
                  <span className="px-1.5 py-0.2 bg-red-600 text-white text-[8px] tracking-wide rounded uppercase font-extrabold shadow-xs">
                    1967 Audit
                  </span>
                </button>
                ...
                {/* Eighteenmile Creek Superfund & Fine-Line Remediation (Deep-AI Dive) */}
                <button
                  onClick={() => setActiveTab('eighteenmile_creek')}
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left text-xs font-medium tracking-tight transition-all cursor-pointer border ${
                    activeTab === 'eighteenmile_creek' || (activeTab as string) === 'eighteenmile' || (activeTab as string) === 'superfund' || (activeTab as string) === 'superfund_remediation'
                      ? 'bg-amber-950 text-amber-100 border-amber-500 shadow-md font-bold ring-1 ring-amber-400/50'
                      : 'hover:bg-amber-500/20 text-amber-950 border-amber-400/60 bg-amber-50/90 font-bold'
                  }`}
                >
                  <Building size={16} className={activeTab === 'eighteenmile_creek' ? 'text-amber-300 animate-pulse' : 'text-amber-700'} />
                  <span className="flex-1 font-semibold">👑 Eighteenmile Creek Superfund</span>
                  <span className="px-1.5 py-0.2 bg-amber-600 text-white text-[8px] tracking-wide rounded uppercase font-extrabold shadow-xs">
                    Deep-AI Dive
                  </span>
                </button>
                ...
                {/* Public Interest Technology & Lead Paint Prevention */}
                <button
                  onClick={() => setActiveTab('public_interest_tech')}
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left text-xs font-medium tracking-tight transition-all cursor-pointer border ${
                    activeTab === 'public_interest_tech' || (activeTab as string) === 'public_interest_technology' || (activeTab as string) === 'pit' || (activeTab as string) === 'public_tech'
                      ? 'bg-sky-950 text-sky-100 border-sky-400 shadow-md font-extrabold ring-2 ring-sky-400/80'
                      : 'hover:bg-sky-500/20 text-sky-950 border-sky-400/70 bg-sky-50/90 font-bold'
                  }`}
                >
                  <Lightbulb size={16} className={activeTab === 'public_interest_tech' ? 'text-sky-300 animate-pulse' : 'text-sky-700'} />
                  <span className="flex-1 font-semibold">💡 What is Public Interest Tech?</span>
                  <span className="px-1.5 py-0.2 bg-sky-600 text-white text-[8px] tracking-wide rounded uppercase font-extrabold shadow-xs">
                    PIT / Lead
                  </span>
                </button>
        ...
        <section className={`flex-1 flex flex-col overflow-hidden transition-colors duration-200 ${
          ...
          {/* TAB 2.115B: ROANOKE LEAD AUDIT: $6.25M HUD REMEDIATION & PRE-1978 HOUSING FORENSICS (PLATE #42) */}
          {(activeTab === 'roanoke_lead_audit' || (activeTab as string) === 'roanoke' || (activeTab as string) === 'roanoke_lead' || (activeTab as string) === 'plate_42' || (activeTab as string) === 'plate42') && (
            <div className="flex-1 overflow-y-auto">
              <RoanokeLeadAudit 
                onNavigateTab={(tab) => setActiveTab(tab as any)}
          ...
          {/* TAB 2.115C: JACKSON, MISSISSIPPI LEAD WATER AUDIT: 5TH CIR. EN BANC RULING & CORRUPTION AUDIT (PLATE #43) */}
          {(activeTab === 'jackson_lead_audit' || (activeTab as string) === 'jackson' || (activeTab as string) === 'jackson_water' || (activeTab as string) === 'plate_43' || (activeTab as string) === 'plate43') && (
            <div className="flex-1 overflow-y-auto">
              <JacksonLeadAudit 
                onNavigateTab={(tab) => setActiveTab(tab as any)}
          ...
          {/* TAB 2.117A00: GOOGLE'S GEMINI AUTONOMOUS INFILTRATION FORENSIC & ICEARTH SOVEREIGN DEFENSE (PLATE #53) */}
          ...
          {/* TAB 2.117B: THE INDIGENOUS AI SOLUTION FOR AI: THE ICEARTH STACK (PLATE #38) */}
          ...
          {/* TAB 2.117B1.1: SOVEREIGN IDENTITY VS THE AI MIRAGE: DEFENDING INDIGENOUS HERALDRY */}
          {(activeTab === 'sovereign_identity' || (activeTab as string) === 'ai_mirage' || (activeTab as string) === 'seal_defense' || (activeTab as string) === 'cherokee_seal' || (activeTab as string) === 'hoskin_directive' || (activeTab as string) === 'anadisgoi') && (
            <div className="flex-1 overflow-y-auto">
              <SovereignIdentityAIMirage 
                onNavigateTab={(tab) => setActiveTab(tab as any)}
                siteTheme={siteTheme}
              />
            </div>
          ...
          {/* TAB 2.117B2: ARTIFICIAL INTELLIGENCE AND THE KEHOE RULE (PLATE #41) */}
          ...
          {/* TAB 2.118C: miRNA-31 / Nrf2 EPIGENETIC AXIS OF HARM IN LEAD TOXICITY (AIIMS JODHPUR / SPRINGER 2026) */}
          {(activeTab === 'mirna31_nrf2_lead' || (activeTab as string) === 'mirna31' || (activeTab as string) === 'mirna-31' || (activeTab as string) === 'nrf2' || (activeTab as string) === 'plate_36' || (activeTab as string) === 'plate36') && (
            <div className="flex-1 overflow-y-auto">
              <MiRNA31Nrf2LeadEpigenetics 
                onNavigateTab={(tab) => setActiveTab(tab as any)}
                siteTheme={siteTheme}
              />
            </div>
          ...
          {/* TAB 2.118B: JICARILLA APACHE PROJECT GASBUGGY (1967) NUCLEAR DETONATION & ENVIRONMENTAL AUDIT */}
          {(activeTab === 'jicarilla_gasbuggy_audit' || (activeTab as string) === 'gasbuggy' || (activeTab as string) === 'jicarilla_audit' || (activeTab as string) === 'ice_jicarilla' || (activeTab as string) === 'gasbuggy_audit') && (
            <div className="flex-1 overflow-y-auto">
              <ICEJicarillaGasbuggyAudit 
                onNavigateTab={(tab) => setActiveTab(tab as any)}
                siteTheme={siteTheme}
              />
            </div>
          ...
          {/* TAB 2.121: EIGHTEENMILE CREEK SUPERFUND & FINE-LINE RESIDENTIAL REMEDIATIONS (DEEP-AI DIVE) */}
          ...
          {/* TAB 2.126: WHAT IS PUBLIC INTEREST TECHNOLOGY (PIT) & PREVENTING CHILDHOOD LEAD POISONING */}
          {(activeTab === 'public_interest_tech' || (activeTab as string) === 'public_interest_technology' || (activeTab as string) === 'pit' || (activeTab as string) === 'public_tech') && (
            <div className="flex-1 overflow-y-auto">
