...
export const ClevelandLeadAudit: React.FC<ClevelandLeadAuditProps> = ({ onNavigateTab }) => {
  ...
  const [activeDossierTab, setActiveDossierTab] = useState<'unspent_scandal' | 'corporate_science' | 'letter' | 'timeline' | 'pillars' | 'quinn_part3' | 'quinn_part4' | 'quinn_part5' | 'quinn_podcast' | 'quinn_epilogue' | 'axios_critique' | 'horner_letter' | 'sw_dispute' | 'fed_legislation' | 'moulthrop_kelsey_letter'>('letter');
      ...
      {/* TOP COMPONENT: SWITCHED VIEWS */}
        ...
        <div id="exhibit-c4c-sw-coverup" className="mt-12 p-8 border-2 border-rose-900 bg-neutral-950 rounded-3xl space-y-8 relative overflow-hidden shadow-2xl">
          ...
          <div className="flex border-b border-neutral-900 gap-1 relative z-10 overflow-x-auto scrollbar-thin">
            ...
            <button
              onClick={() => setActiveDossierTab('corporate_science')}
              className={`px-5 py-3 font-sans text-xs font-bold uppercase tracking-wider transition-all border-b-2 cursor-pointer flex items-center gap-1.5 shrink-0 ${
                activeDossierTab === 'corporate_science'
                  ? 'border-amber-500 text-amber-300 bg-amber-950/20 font-bold'
                  : 'border-transparent text-neutral-500 hover:text-neutral-300 hover:bg-neutral-900/40'
              }`}
            >
              <BookOpen size={13} className="text-amber-400" />
              <span>📚 Corporate Science & Historiography Library</span>
            </button>
            <button
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="p-6 bg-neutral-900/90 border border-neutral-800 rounded-2xl space-y-4">
                      <div className="flex items-center justify-between border-b border-neutral-800 pb-3">
                        <span className="text-[10px] font-mono font-bold text-purple-400 uppercase tracking-wider flex items-center gap-1.5">
                          ...
                          Exhibit 3: Motley Rice Lawsuit Sabotage & The 2009 Political Retaliation
                        </span>
                        <span className="text-[10px] font-mono text-neutral-400">The 20-Year Suppression</span>
                      </div>
                      <p className="text-xs text-neutral-300 leading-relaxed">
                        In 2006, <strong>Norman Roulet</strong> served as Co-Chair of the <strong>Greater Cleveland Lead Advisory Council (GCLAC)</strong> alongside East Cleveland Mayor <strong>Eric Brewer</strong>. Together, they partnered with national tort firm <strong>Motley Rice</strong> to bring a public nuisance lawsuit against Sherwin-Williams and other lead pigment manufacturers, modeled on the California litigation to compel comprehensive residential lead abatement across Cuyahoga County.
                      </p>
                      <div className="p-4 bg-purple-950/30 border border-purple-800/40 rounded-xl space-y-3 text-xs text-neutral-300">
                        <strong className="text-purple-300 font-mono text-[11px] block">
                          POLITICAL RETALIATION & LITIGATION DISRUPTION:
                        </strong>
                        <p className="text-[11.5px] leading-relaxed">
                          Rather than joining the legal effort, Cleveland and Cuyahoga County leadership opposed GCLAC's initiative. In the 2009 election cycle, private materials from a stolen computer were publicly leaked in an aggressive smear campaign against Mayor Eric Brewer, leading to his primary defeat. Following this political transition, municipal momentum for lead litigation dissolved, Ohio Attorney General Richard Cordray abandoned the state’s public nuisance claims, and the state legislature enacted statutory restrictions on municipal lead paint lawsuits.
                        </p>
                        <p className="text-[11.5px] leading-relaxed">
                          <strong>The California Contrast:</strong> In California, where 10 cities and counties (including Los Angeles, San Francisco, and Oakland) supported Motley Rice through trial, the courts ordered Sherwin-Williams, NL Industries, and ConAgra to pay <strong>$305 Million</strong> into an environmental abatement fund. Cuyahoga County received $0 and forfeited its children to ongoing exposure.
                        </p>
                      </div>
                    </div>

                    {/* Chronicle 4: Spectrum News 1 - The NGO Buffer & Accountability Diffusion */}
                    <div className="p-6 bg-neutral-900/90 border border-neutral-800 rounded-2xl space-y-4">
                      <div className="flex items-center justify-between border-b border-neutral-800 pb-3">
                        <span className="text-[10px] font-mono font-bold text-cyan-400 uppercase tracking-wider flex items-center gap-1.5">
                          <Users size={14} className="text-cyan-400" />
                          Exhibit 4: Spectrum News 1 Audit • The Non-Profit Buffer & Accountability Diffusion
                        </span>
                        <span className="text-[10px] font-mono text-neutral-400">Published Aug. 20, 2026</span>
                      </div>
                      <p className="text-xs text-neutral-300 leading-relaxed">
                        Reporting by Halena Sepulveda (<em>Spectrum News 1</em>) on August 20, 2026, details how frontline organizations—including <strong>Enterprise Community Partners</strong>, <strong>Environmental Health Watch</strong>, and the <strong>Lead Safe Cleveland Coalition</strong>—are deployed to conduct community education, hotlines, and landlord workshops in a city where <strong>14.5% to 18% of children</strong> (and over 25% in high-risk ZIP codes) test positive for toxic lead exposure.
                      </p>
                      <div className="p-4 bg-cyan-950/30 border border-cyan-800/40 rounded-xl space-y-2 text-xs text-neutral-300">
                        <strong className="text-cyan-300 font-mono text-[11px] block">
                          THE STRUCTURAL ACCOUNTABILITY PARADOX:
                        </strong>
                        <ul className="list-disc list-inside space-y-1.5 text-[11.5px] text-neutral-300 leading-relaxed">
                          <li><strong>Education vs. Physical Removal:</strong> Educational hotlines and brochures inform residents about peeling paint, but cannot physically replace deteriorating windows or extract lead service lines.</li>
                          <li><strong>The Institutional Buffer:</strong> By delegating primary public health response to non-profit entities dependent on competitive short-term grants, municipal government buffers itself from accountability when millions in remediation funds go unspent.</li>
                          <li><strong>Unspent Millions:</strong> While non-profits operate resource lines, $1.2M in county lead remediation grants lapsed unspent in July 2026, compounding the $3.3M previously forfeited by Cleveland City Hall.</li>
                        </ul>
                      </div>
                    </div>

                    {/* Chronicle 5: Roulet's Law & Why ICEarth Exists */}
                    <div className="p-6 bg-linear-to-br from-neutral-900 to-red-950/30 border border-red-500/30 rounded-2xl space-y-4">
                      <div className="flex items-center justify-between border-b border-red-500/20 pb-3">
                        <span className="text-[10px] font-mono font-bold text-red-400 uppercase tracking-wider flex items-center gap-1.5">
                          ...
                          Exhibit 5: Roulet's Law, "Why Nazis," & ICEarth Sovereignty
                        </span>
            ...
            {/* =========================================================================
                TAB: CORPORATE SCIENCE & HISTORIOGRAPHY LIBRARY
                ========================================================================= */}
            {activeDossierTab === 'corporate_science' && (
              <div className="lg:col-span-12 space-y-6 animate-fade-in text-neutral-200 font-sans">
                {/* Header Banner */}
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-4 border-b border-amber-800/50">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <span className="px-2.5 py-0.5 bg-amber-500/20 text-amber-300 font-mono text-[9px] uppercase font-bold rounded-full border border-amber-500/40 flex items-center gap-1">
                        <BookOpen size={10} className="text-amber-400" />
                        Historiographical & Toxicological Canon
                      </span>
                      <span className="text-[10px] font-mono text-neutral-400">
                        Peer-Reviewed Books & Archival Research
                      </span>
                    </div>
                    <h4 className="text-xl font-serif font-bold text-neutral-100">
                      The Corruption of Science: How the Lead Industry Manufactured Doubt & Delayed Abatement
                    </h4>
                    <p className="text-xs text-neutral-400 max-w-4xl leading-relaxed">
                      Essential literature documenting how the lead industry manipulated public health science, attacked independent researchers, captured federal agencies, and established the "product defense" playbook later adopted by tobacco, asbestos, and chemical cartels.
                    </p>
                  </div>
                  <div className="flex items-center gap-2 shrink-0">
                    <span className="px-3 py-1.5 bg-amber-950/60 border border-amber-700/60 text-amber-200 font-mono text-xs font-bold rounded-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {/* Book 1: Deceit and Denial */}
                  <div className="p-6 bg-neutral-900/90 border border-neutral-800 hover:border-amber-500/40 rounded-2xl space-y-4 transition-all flex flex-col justify-between">
                    <div className="space-y-3">
                      <div className="flex items-start justify-between gap-2 border-b border-neutral-800 pb-3">
                        <div>
                          <span className="text-[9px] font-mono font-bold text-amber-400 uppercase tracking-wider block">
                            Foundational Archival Exposé • 2002 / 2013
                          </span>
                          <h5 className="font-serif font-bold text-neutral-100 text-base leading-tight mt-0.5">
                            Deceit and Denial: The Deadly Politics of Industrial Pollution
                          </h5>
                          <span className="text-xs text-neutral-400 font-mono">
                            By Gerald Markowitz & David Rosner (University of California Press / Milbank Memorial Fund)
                          </span>
                        </div>
                      </div>
                      <p className="text-xs text-neutral-300 leading-relaxed">
                        Drawing on thousands of internal, previously secret corporate files and meeting minutes from the <strong>Lead Industries Association (LIA)</strong> and the chemical sector, Markowitz and Rosner demonstrate that industry leaders were intimately aware of childhood lead poisoning deaths and neurological damage in the early 20th century.
                      </p>
                      <div className="p-3.5 bg-amber-950/20 border border-amber-800/30 rounded-xl space-y-1.5 text-xs text-neutral-300">
                        <strong className="text-amber-300 font-mono text-[10.5px] block">
                          CORE ARCHIVAL DISCOVERIES:
                        </strong>
                        <ul className="list-disc list-inside space-y-1 text-[11px] text-neutral-300">
                          <li><strong>Early Internal Foreknowledge:</strong> Manufacturers recognized white lead as a lethal neurotoxin to children while publicly promoting it for nurseries and interior walls.</li>
                          <li><strong>Blaming Parents & "Slums":</strong> Orchestrated PR campaigns engineered to redirect legal liability onto low-income minority parents and substandard tenement upkeep.</li>
                          <li><strong>Courtroom Provenance:</strong> Markowitz and Rosner’s historical documents formed the primary evidentiary basis for public nuisance trials against paint companies across the United States.</li>
                        </ul>
                      </div>
                    </div>
                    <div className="pt-3 border-t border-neutral-800/80 flex items-center justify-between text-[10px] font-mono text-neutral-400">
                      <span>Milbank Books on Health and the Public</span>
                      <span className="text-amber-400 font-bold">LIA ARCHIVE EVIDENCE</span>
                    </div>
                  </div>
                  ...
                  <div className="p-6 bg-neutral-900/90 border border-neutral-800 hover:border-amber-500/40 rounded-2xl space-y-4 transition-all flex flex-col justify-between">
                    <div className="space-y-3">
                      <div className="flex items-start justify-between gap-2 border-b border-neutral-800 pb-3">
                        <div>
                          <span className="text-[9px] font-mono font-bold text-amber-400 uppercase tracking-wider block">
                            The Battle for Children's Brains • 2013
                          </span>
                          <h5 className="font-serif font-bold text-neutral-100 text-base leading-tight mt-0.5">
                            Lead Wars: The Politics of Science and the Fate of America's Children
                          </h5>
                          <span className="text-xs text-neutral-400 font-mono">
                            By Gerald Markowitz & David Rosner (University of California Press / Russell Sage Foundation)
                          </span>
                        </div>
                      </div>
                      <p className="text-xs text-neutral-300 leading-relaxed">
                        Examines the protracted legal, political, and medical battles over low-level (subclinical) lead toxicity. The book reveals how industry lobbyists sought to block lower blood lead thresholds, attacking the science proving that even trace blood lead levels impair cognitive function and impulse control.
                      </p>
                      <div className="p-3.5 bg-amber-950/20 border border-amber-800/30 rounded-xl space-y-1.5 text-xs text-neutral-300">
                        <strong className="text-amber-300 font-mono text-[10.5px] block">
                        ...
                        <ul className="list-disc list-inside space-y-1 text-[11px] text-neutral-300">
                          <li><strong>The Shifting Threshold:</strong> Tracking the gradual reduction of the CDC "safe" level from 60 µg/dL down to 10, 5, 3.5, and the modern consensus that <em>no level is safe</em>.</li>
                          <li><strong>Legal Shielding:</strong> How paint manufacturers used corporate restructuring, state preemption laws, and tort immunities to avoid paying for residential abatement.</li>
                          <li><strong>Housing Inaction:</strong> The failure of federal and municipal governments to mandate proactive primary containment, relegating children to act as toxic detectors.</li>
                        </ul>
                      </div>
                    </div>
                    <div className="pt-3 border-t border-neutral-800/80 flex items-center justify-between text-[10px] font-mono text-neutral-400">
                      <span>Russell Sage Foundation</span>
                      <span className="text-amber-400 font-bold">SUBCLINICAL TOXICITY AUDIT</span>
                    </div>
                  </div>
                  ...
                  <div className="p-6 bg-neutral-900/90 border border-neutral-800 hover:border-amber-500/40 rounded-2xl space-y-4 transition-all flex flex-col justify-between">
                    <div className="space-y-3">
                      <div className="flex items-start justify-between gap-2 border-b border-neutral-800 pb-3">
                        <div>
                          <span className="text-[9px] font-mono font-bold text-amber-400 uppercase tracking-wider block">
                            Scientific Heroism & Corporate Attacks • 2008
                          </span>
                          <h5 className="font-serif font-bold text-neutral-100 text-base leading-tight mt-0.5">
                            Toxic Truth: A Scientist, a Doctor, and the Battle over Lead
                          </h5>
                          <span className="text-xs text-neutral-400 font-mono">
                            By Lydia Denworth (Beacon Press)
                          </span>
                        </div>
                      </div>
                      <p className="text-xs text-neutral-300 leading-relaxed">
                        A dual biography chronicling geochemist <strong>Clair Patterson</strong> and pediatrician/psychiatrist <strong>Dr. Herbert Needleman</strong>, two courageous researchers who proved that industrial lead was poisoning the entire biosphere and human intelligence, facing intense corporate smears and institutional blacklisting.
                      </p>
                      <div className="p-3.5 bg-amber-950/20 border border-amber-800/30 rounded-xl space-y-1.5 text-xs text-neutral-300">
                        <strong className="text-amber-300 font-mono text-[10.5px] block">
                        ...
                        <ul className="list-disc list-inside space-y-1 text-[11px] text-neutral-300">
                          <li><strong>Clair Patterson (Caltech):</strong> Built the first ultra-clean room to date the Earth (4.55 billion years). Proved modern humans have 600x more lead in their bones than pre-industrial ancestors through polar ice core drilling. Smeared by Ethyl Corp and excluded from research panels.</li>
                          <li><strong>Dr. Herbert Needleman (Harvard / Univ. of Pittsburgh):</strong> Conducted the landmark 1979 study measuring lead in children's baby teeth, proving low-level lead drops IQ and causes behavioral deficits. Endured relentless industry-funded fraud charges before full exoneration.</li>
                        </ul>
                      </div>
                    </div>
                    <div className="pt-3 border-t border-neutral-800/80 flex items-center justify-between text-[10px] font-mono text-neutral-400">
                      <span>Beacon Press</span>
                      <span className="text-amber-400 font-bold">PATTERSON & NEEDLEMAN HEROISM</span>
                    </div>
                  </div>

                  {/* Book 4: Doubt is Their Product */}
                  <div className="p-6 bg-neutral-900/90 border border-neutral-800 hover:border-amber-500/40 rounded-2xl space-y-4 transition-all flex flex-col justify-between">
                    <div className="space-y-3">
                      <div className="flex items-start justify-between gap-2 border-b border-neutral-800 pb-3">
                        <div>
                          <span className="text-[9px] font-mono font-bold text-amber-400 uppercase tracking-wider block">
                            The Science Defense Playbook • 2008
                          </span>
                          <h5 className="font-serif font-bold text-neutral-100 text-base leading-tight mt-0.5">
                            Doubt is Their Product: How Industry's Assault on Science Threatens Your Health
                          </h5>
                          <span className="text-xs text-neutral-400 font-mono">
                            By David Michaels (Former Assistant Secretary of Labor for OSHA • Oxford University Press)
                          </span>
                        </div>
                      </div>
                      <p className="text-xs text-neutral-300 leading-relaxed">
                        Former OSHA head David Michaels exposes the lucrative "product defense" industry that specializes in manufacturing scientific uncertainty. The lead industry created the prototype strategy later perfected by Big Tobacco, chemical conglomerates, and fossil fuel giants to delay life-saving regulations for decades.
                      </p>
                      <div className="p-3.5 bg-amber-950/20 border border-amber-800/30 rounded-xl space-y-1.5 text-xs text-neutral-300">
                        <strong className="text-amber-300 font-mono text-[10.5px] block">
                          THE PRODUCT-DEFENSE METHODOLOGY:
                        </strong>
                        <ul className="list-disc list-inside space-y-1 text-[11px] text-neutral-300">
                          <li><strong>Manufacturing Uncertainty:</strong> Demanding unattainable standards of proof and re-analyzing independent data using biased statistical tricks to claim "the science is unsettled."</li>
                          <li><strong>Attacking Scientific Integrity:</strong> Launching ad hominem attacks and legal subpoenas against independent researchers to silence peer-reviewed findings.</li>
                          <li><strong>Regulatory Delay as Profit:</strong> Every year of manufactured doubt allowed corporations to extract hundreds of millions in profit while passing irreversible health costs to society.</li>
                        </ul>
                      </div>
                    </div>
                    <div className="pt-3 border-t border-neutral-800/80 flex items-center justify-between text-[10px] font-mono text-neutral-400">
                      <span>Oxford University Press</span>
                      <span className="text-amber-400 font-bold">CORPORATE "DOUBT PLAYBOOK"</span>
                    </div>
                  </div>
                ...
                <div className="p-6 bg-gradient-to-br from-neutral-900 to-amber-950/30 border border-amber-500/30 rounded-2xl space-y-3">
                  <div className="flex items-center gap-2 text-amber-400 font-mono text-xs font-bold uppercase">
                    <ShieldCheck size={16} />
                    <span>Scientific Synthesis: The Epistemological Mechanics of Lead Denial</span>
                  </div>
                  <p className="text-xs text-neutral-300 leading-relaxed">
                    These four definitive works establish an unassailable historical and scientific reality: the continued poisoning of children in older industrial cities like Cleveland, Detroit, Philadelphia, and Baltimore is not the consequence of scientific ambiguity or parental ignorance. It is the direct mathematical consequence of a century-long, documented campaign that corrupted regulatory bodies, subverted public health science, and shielded multi-billion dollar corporations from the physical cost of cleaning their toxic legacy.
                  </p>
                  <div className="pt-2 flex flex-wrap items-center gap-4 text-[10px] font-mono text-amber-300 border-t border-amber-500/20">
                    <span>Key Concepts: Clair Patterson Geochemical Baselines</span>
                    <span>•</span>
                    <span>Herbert Needleman Dentin Studies</span>
                    <span>•</span>
                    <span>LIA Toxic Docs Archive</span>
                    <span>•</span>
                    <span>Product Defense Playbook</span>
                  </div>
                </div>
              </div>
            )}
