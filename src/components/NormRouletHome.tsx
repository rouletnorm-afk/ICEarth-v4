...
const resolvePhotoUrl = (url: string): string => {
  ...
  if (
    ...
    u.includes('user_3') ||
    u.includes('user3') ||
    u.includes('photo-000bg') ||
    u.includes('ip-000bg') ||
    u.includes('0xuser_003_deb_haaland')
  ) {
...
Human sovereignty remains absolute. True data sovereignty cannot be granted by Silicon Valley watchdogs—it is owned by the people and protected by sovereign architecture.`,
    ...
    },
    {
      ...
      publishedUrl: 'https://x.com/DebHaalandNM/status/2100685661917553063',
      summary: "Governor Deb Haaland, enrolled member of Laguna Pueblo, 35th Generation New Mexican, former US Secretary of the Interior, and future Governor, has issued an emergency call for a statewide moratorium on extractive data centers until developers satisfy 8 strong accountability laws. Welcomed as ICEarth User #3 alongside Founder Norm Roulet (User #1) and Master Phytoremediator Ouray Muskrat (User #2), this case study features Plate #52 (The 8 Laws of New Mexico IT Sovereignty Infographic Plate with her official portrait, statement, and 8 accountability measures) and Plate #51 (Deb Haaland User #3 Sovereign Credential), demonstrating how ICEarth's decentralized, waterless (0 gal/day), 100% tribal solar-powered hybrid IT architecture natively fulfills every mandate.",
      fullText: `GOVERNOR DEB HAALAND'S 8 LAWS OF NEW MEXICO IT SOVEREIGNTY: WHY ICEARTH SOVEREIGN COMPUTING IS THE SOLUTION FOR THE LAND OF ENCHANTMENT
...
Governor Deb Haaland is officially welcomed to Indigenous Communities Earth as User #3. Together with User #1 Norm Roulet and User #2 Ouray Muskrat, New Mexico will lead the world in sovereign green computing.`,
      tags: ['DebHaaland', 'User003', 'Plate51', 'LagunaPueblo', 'DataCenterMoratorium', 'NewMexico', 'SovereignAI', 'ClosedLoopWaterless', 'TribalSolar', 'ShamirSecretSharing', 'IndigenousDataSovereignty', 'Exposenomics', 'TaosNM'],
      linkHash: '0xUSER_003_DEB_HAALAND_LAGUNA_PUEBLO_SOVEREIGN_VAULT_2026'
    },
    {
...
The Ministry of Health and Family Welfare lacks a single national reference laboratory for blood lead testing, leaving pediatricians unable to diagnose lead toxicity in clinical settings. UNICEF and health experts demand comprehensive source prevention, deposit-refund battery schemes, and public testing infrastructure.`,
    ...
    },
    {
      ...
      summary: "New Narratives / Pure Earth / Ghana Health Service Investigation: A landmark survey discovered over 50% of children in 9 Greater Accra communities have unsafe blood lead levels (≥ 5 µg/dL), with 31 children exceeding 45 µg/dL requiring emergency medical chelation. Residential soil near used battery recycling smelters (Success Africa, White Star, Recyclers Ghana) tests up to 7,000 ppm (35x EPA limits). Three years later, government guidelines remain unfinished, leaving children and families in peril.",
      fullText: `GHANA’S SILENT POISON: THREE YEARS AFTER LANDMARK SURVEY FOUND CHILDREN BEING POISONED BY LEAD, SLOW PACE OF REFORMS IS PUTTING MORE CHILDREN AT RISK
...
I. THE LANDMARK 2023 STUDY & THREE YEARS OF REGULATORY STAGNATION:
In 2023, concern about expanding used lead-acid battery (ULAB) recycling and e-waste processing prompted the Ghana Health Service to conduct a major blood lead level survey across 9 communities in three regions. Over half the children tested had blood lead levels of 5 µg/dL or higher (the WHO intervention threshold). For 31 children, levels exceeded 45 µg/dL, requiring urgent hospital chelation therapy to prevent seizures, encephalopathy, and death. Yet the government withheld the results for two years, and guidelines remain unfinished three years later.

II. SOIL LEAD REACHES 7,000 PPM (35x US EPA STANDARD):
Rev. Dr. Esmond Quansah, Pure Earth's Africa Director, revealed that residential soil in Afienya, Ashaiman, and Kpone reached 7,000 parts per million—compared to the US EPA residential ceiling of 200 ppm.

III. BATTERY RECYCLING DANGER ZONES:
The highest contamination was identified around three formal used lead-acid battery recycling plants:
1. Success Africa Ghana Ltd (Shai-Osudoku District)
2. White Star Global Ltd (Kpone-Katamanso Municipality)
3. Recyclers Ghana Ltd (Tema Corridor)
These plants process spent vehicle and solar batteries imported from Europe and North America without proper baghouse filtration or acid runoff control.

IV. SYNAPTIC COLLAPSE & COGNITIVE MEMORY LOSS:
UNICEF Ghana health specialist Dr. Emmanuel Kyeremanteng-Amoah warns: "The neurons cannot join together to store information—today you teach the child 1+1=2, the next day he has forgotten because he cannot do the recall. The child cannot learn, drops out of school, develops aggressive tendencies, and increases prison recidivism. You have a nation whose productivity is going down."

V. GLOBAL TOLL:
Lead poisoning is estimated to kill more people worldwide each year than malaria and HIV/AIDS combined. The WHO confirms no safe blood lead level exists.`,
      tags: ['GhanaSilentPoison', 'BatteryRecycling', 'Tema', 'PureEarth', 'UNICEF', 'ChildLeadPoisoning', 'ChelationTherapy', 'Plate39'],
      linkHash: '0xGHANA_SILENT_POISON_LEAD_ACID_BATTERY_2026',
      publishedUrl: 'https://newnarratives.org/stories/environment-and-climate-reporting/ghanas-silent-poison-three-years-after-landmark-survey-found-children-being-poisoned-by-lead-slow-pace-of-reforms-is-putting-more-children-at-risk/'
    },
    {
...
From Flint, Michigan—the national capital of environmental genocide—this report provides indisputable real-world proof of Roulet’s Law. Roulet’s Law asserts that environmental lead poisoning causes irreversible neurological damage to prefrontal impulse control and emotional regulation. When compounded by systemic trauma, poverty, and social isolation, environmental lead poisoning manifests directly as community violence and tragedy. Resolving community violence requires eliminating toxic lead exposures at their root.`,
  ...
  const basePhotographyGallery: PhotoGalleryItem[] = [
    ...
    },
    {
      ...
      category: 'Indigenous IT Sovereignty, Data Center Moratorium & High Desert Clean Compute',
      imageSrc: nmItSovereigntyPlateImg,
      location: 'Laguna Pueblo, New Mexico • Sovereign Cloud Enclave',
      date: '2026-09-17',
      ...
      tags: ['DebHaaland', 'Plate52', '8LawsOfNMIT', 'LagunaPueblo', 'GovernorOfNM', 'DataCenterMoratorium', 'WaterProtection', 'ZeroWaterCooling', 'SolarMicrogrids', 'TribalSovereignty', 'Exposenomics']
    },
    {
      id: 'PHOTO-000BJ',
      title: "Ancestral Homeland of Deb Haaland: The Historic Village of Old Laguna & Mount Taylor, New Mexico",
      category: 'Indigenous Landscapes, Pueblo Architecture & Authentic Geography',
      imageSrc: lagunaHomelandLandscapeImg,
      location: 'Laguna Pueblo (Kawaik), Cibola County, New Mexico',
      date: '2026-09-17',
      ...
      vaultHash: '0xLAGUNA_PUEBLO_ANCESTRAL_HOMELAND_LANDSCAPE_2026',
      tags: ['LagunaPueblo', 'Kawaik', 'OldLaguna', 'MountTaylor', 'Tsiipiya', 'DebHaaland', 'PuebloArchitecture', 'CibolaCounty', 'IndigenousGeography', 'Sovereignty']
    },
    {
      id: 'PHOTO-000BG',
      ...
      category: 'Indigenous Sovereignty, User Account Profile & Sovereign Credentials',
      ...
      tags: ['DebHaaland', 'Plate51', 'User3', 'LagunaPueblo', 'GovernorOfNM', '35thGeneration', 'InteriorSecretary', 'TribalSovereignty', 'Exposenomics']
    },
    {
      id: 'PHOTO-000BF',
      title: 'The Global AI Sovereignty Imperative: Indigenous Nations vs. Toothless Corporate Watchdogs — CNBC Forensic Critique (Plate #50)',
    ...
    },
    {
      ...
      category: 'Used Battery Recycling (ULAB), E-Waste Dumping & Pediatric Neurotoxicology',
      imageSrc: ghanaSilentPoisonImg,
      location: 'Tema, Afienya, Ashaiman & Kpone, Greater Accra Region, Ghana',
      date: '2026-09-04',
      ...
      tags: ['GhanaSilentPoison', 'Plate39', 'BatteryRecycling', 'Tema', 'Kpone', 'Ashaiman', 'Afienya', 'PureEarth', 'UNICEF', 'ChildLeadPoisoning', 'ChelationTherapy', 'EDTA', 'DMSA', 'Ewaste', 'BaselConvention', 'RouletsLaw', 'ICEarth']
    },
    {
      id: 'PHOTO-000AT',
